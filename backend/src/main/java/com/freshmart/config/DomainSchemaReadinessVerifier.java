...
public class DomainSchemaReadinessVerifier implements SmartInitializingSingleton {
    ...
    private Map<String, Set<String>> requiredTables() {
        return Map.of(
                "freshmart_user", Set.of("users", "user_role_assignments", "auth_sessions", "user_addresses", "wallet_accounts", "wallet_transactions", "user_memberships", "points_transactions", "user_coupons"),
                ...
                "freshmart_log", Set.of("audit_logs", "inbox_messages", "integration_outbox"));
    }
